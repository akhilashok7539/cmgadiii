...
@Component({
  ...
  templateUrl: './adddriver-profilepic.component.html',
  styleUrls: ['./adddriver-profilepic.component.css']
})
export class AdddriverProfilepicComponent implements OnInit {
  driverModel: Driver;
