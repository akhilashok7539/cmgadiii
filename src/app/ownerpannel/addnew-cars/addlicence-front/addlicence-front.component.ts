...
@Component({
  ...
  templateUrl: './addlicence-front.component.html',
  styleUrls: ['./addlicence-front.component.css']
})
export class AddlicenceFrontComponent implements OnInit {
      ...
      if (this.addVehiclesform.invalid) {
        ...
        this.owenerservice.addimages(this.formData).subscribe(
          data =>{
            Swal.fire(
              'Licence Front Added!',
              'Licence Front Added Successfully',
              'success'
            )
          ...
          error =>{
            Swal.fire(
              'Licence Front Added Error!',
              'Licence Front Added SUnccessfully',
              'error'
            )
          }
        )
